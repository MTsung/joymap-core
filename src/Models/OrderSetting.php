...
class OrderSetting extends Model
{
    ...
    public const ORDER_UNIT_MINUTE_DEFAULT = '30';// 預設的預約預約區間 (分鐘)
    public const CAN_ORDER_DAY_DEFAULT = '14';// 預設於多久前可開放預約(天)
    public const SINGLE_TIME_ORDER_TOTAL_DEFAULT = '6';// 預設的單次預約最大總數(含小孩)
    public const FINAL_ORDER_MINUTE_DEFAULT = '0';// 預設須於多久前完成預約(分鐘)
    public const FINAL_CANCEL_MINUTE_DEFAULT = '0';// 預設最晚多久以前可以取消預約(分鐘)
    public const HOLD_ORDER_MINUTE_DEFAULT = '10';// 預設預約保留時間(分鐘)
